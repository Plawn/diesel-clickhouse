...
impl_query_fragment_tuple!(A, B, C, D, E, F, G, H, I);
impl_query_fragment_tuple!(A, B, C, D, E, F, G, H, I, J);
impl_query_fragment_tuple!(A, B, C, D, E, F, G, H, I, J, K);
impl_query_fragment_tuple!(A, B, C, D, E, F, G, H, I, J, K, L);
impl_query_fragment_tuple!(A, B, C, D, E, F, G, H, I, J, K, L, M);
impl_query_fragment_tuple!(A, B, C, D, E, F, G, H, I, J, K, L, M, N);
impl_query_fragment_tuple!(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O);
impl_query_fragment_tuple!(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P);
